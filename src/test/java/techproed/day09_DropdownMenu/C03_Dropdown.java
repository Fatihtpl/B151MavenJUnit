...
public class C03_Dropdown {
    ...
    @Test
    public void test01() {
     //programing languages ddm den istediginiz 4 secenegi seciniz.
        ...
        //senfKeys() methodu ile istedigimiz bir secenegi gonderelim.
        //diller.sendKeys("C#");
        bekle(3);
    ...
    public void selectVisibleText(WebElement ddm, String text){  //text ile secim yapmak icin method olustrduk.
    ...
    public void selectIndex(WebElement ddm, int index){          //index ile secim yapmak icin method olustrduk.
        Select select = new Select(ddm);
        select.selectByIndex(index);
    }
    public void selectValue(WebElement ddm, String value){        //value ile secim yapmak icin method olustrduk.
        Select select = new Select(ddm);
    ...
    public void bekle(int saniye){                              //Thread.sleep icin method olusturduk.
        try {

...
public class C01_NoSuchElementException extends TestBase {
    ...
    public void test01() {
        ...
        WebElement aramaKutusu = driver.findElement(By.xpath("//*[@type='ssearch']"));//bilerek yanlis locate yazildi.
        /*
    ...
    public void test02() {
        ...
        driver.findElement(By.xpath("//*[@class='eicon-close']")).click();
        //arama kutusunda qa aratalım
        WebElement aramaKutusu = driver.findElement(By.cssSelector("//*[@type='search']"));//bilerek xpath ile alinan locate'i css olarak yazdik.
        /*
